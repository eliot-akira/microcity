(function () {
    ...
    class TileSet {
      constructor(image, callback, errorCallback) {
        ...
        let notifications = 0;
        const self = this;
        const imageLoad = /* @__PURE__ */ __name$10(function() {
          notifications++;
    ...
    __name$$(getRandom16, "getRandom16");
    ...
    __name$$(getRandom16Signed, "getRandom16Signed");
    const Random = {
      getChance,
      getERandom,
      getRandom,
    ...
    __name$_(DirectionValue, "DirectionValue");
    ...
    __name$_(directionIndex, "directionIndex");
    ...
    __name$_(forEachCardinalDirection, "forEachCardinalDirection");
    function getRandomCardinalDirection() {
      return getRandomDirectionFrom(cardinalDirections);
    }
    __name$_(getRandomCardinalDirection, "getRandomCardinalDirection");
    function getRandomDirection() {
      return getRandomDirectionFrom(allDirections);
    }
    __name$_(getRandomDirection, "getRandomDirection");
    ...
    __name$_(getRandomDirectionFrom, "getRandomDirectionFrom");
    ...
    __name$Y(DirectionDelta, "DirectionDelta");
    ...
    __name$Y(getDeltaFor, "getDeltaFor");
    class Position {
      constructor(x, y) {
        this.x = x;
        this.y = y;
    ...
    const clearMap = /* @__PURE__ */ __name$U(function(map) {
    ...
    var makeNakedIsland = /* @__PURE__ */ __name$U(function(map) {
    ...
    var makeIsland = /* @__PURE__ */ __name$U(function(map) {
      makeNakedIsland(map);
      smoothRiver(map);
      doTrees(map);
    }, "makeIsland");
    var makeLakes = /* @__PURE__ */ __name$U(function(map) {
      let numLakes;
    ...
    var makeSingleLake = /* @__PURE__ */ __name$U(function(map, pos) {
    ...
    const treeSplash = /* @__PURE__ */ __name$U(function(map, x, y) {
      let numTrees;
    ...
    var doTrees = /* @__PURE__ */ __name$U(function(map) {
      let amount;
    ...
    var smoothRiver = /* @__PURE__ */ __name$U(function(map) {
      const dx = [-1, 0, 1, 0];
      const dy = [0, 1, 0, -1];
      for (let x = 0; x < map.width; x++) {
        for (let y = 0; y < map.height; y++) {
    ...
    const isTree = /* @__PURE__ */ __name$U(function(tileValue) {
      return tileValue >= WOODS_LOW && tileValue <= WOODS_HIGH;
    }, "isTree");
    var smoothTrees = /* @__PURE__ */ __name$U(function(map) {
      for (let x = 0; x < map.width; x++) {
        for (let y = 0; y < map.height; y++) {
    ...
    var smoothTreesAt = /* @__PURE__ */ __name$U(function(map, x, y, preserve) {
      const dx = [-1, 0, 1, 0];
      const dy = [0, 1, 0, -1];
      if (!isTree(map.getTileValue(x, y)))
        return;
    ...
    var doRivers = /* @__PURE__ */ __name$U(function(map, terrainPos) {
    ...
    var doBRiver = /* @__PURE__ */ __name$U(function(map, pos, riverDir, terrainDir) {
      let rate1, rate2;
      {
        rate1 = 100;
        rate2 = 200;
    ...
    var doSRiver = /* @__PURE__ */ __name$U(function(map, pos, riverDir, terrainDir) {
      let rate1, rate2;
      {
        rate1 = 100;
        rate2 = 200;
    ...
    const putOnMap = /* @__PURE__ */ __name$U(function(map, newVal, x, y) {
      if (newVal === 0)
        return;
    ...
    var plopBRiver = /* @__PURE__ */ __name$U(function(map, pos) {
      const BRMatrix = [
    ...
    var plopSRiver = /* @__PURE__ */ __name$U(function(map, pos) {
      const SRMatrix = [
        [0, 0, REDGE, REDGE, 0, 0],
    ...
    const MapGenerator = /* @__PURE__ */ __name$U(function(w, h) {
      w = w || 120;
      h = h || 100;
    ...
    const ID = /* @__PURE__ */ __name$T((n) => n, "ID");
    class BlockMap {
    ...
    const isCommercialZone = /* @__PURE__ */ __name$S(function(tile) {
    ...
    const isIndustrialZone = /* @__PURE__ */ __name$S(function(tile) {
    ...
    const isResidentialZone = /* @__PURE__ */ __name$S(function(tile) {
    ...
    const randomFire = /* @__PURE__ */ __name$S(function() {
      return new Tile(FIRE + (Random.getRandom16() & 3), ANIMBIT);
    }, "randomFire");
    const randomRubble = /* @__PURE__ */ __name$S(function() {
    ...
    const clamp = /* @__PURE__ */ __name$R(function(value, min, max) {
      if (value < min)
        return min;
      if (value > max)
        return max;
    ...
    const makeConstantDescriptor = /* @__PURE__ */ __name$R(function(value) {
      return {
        configurable: false,
        enumerable: false,
        writeable: false,
    ...
    const normaliseDOMid = /* @__PURE__ */ __name$R(function(id) {
      return (id[0] !== "#" ? "#" : "") + id;
    }, "normaliseDOMid");
    const reflectEvent = /* @__PURE__ */ __name$R(function(message, value) {
        ...
        for (yy = y - 1; yy <= y + 1; yy++) {
          for (xx = x - 1; xx <= x + 1; xx++) {
            ...
            map.setTile(
              x,
              y,
              LHTHR + lpValue + Random.getRandom(2),
              BLBNCNBIT
            );
          }
        }
    ...
    var setSpendRangeText = /* @__PURE__ */ __name$l(function(element, percentage, totalSpend) {
    ...
    var onFundingUpdate = /* @__PURE__ */ __name$l(function(elementID, e) {
    ...
    var onTaxUpdate = /* @__PURE__ */ __name$l(function(e) {
      var elem = $("#taxRateLabel")[0];
      var sourceElem = $("#taxRate")[0];
      $(elem).text(["Tax rate: ", sourceElem.value, "%"].join(""));
    }, "onTaxUpdate");
    var resetItems = /* @__PURE__ */ __name$l(function(e) {
    ...
    var cancel$4 = /* @__PURE__ */ __name$l(function(e) {
      e.preventDefault();
      this.close({ cancelled: true });
    }, "cancel");
    var submit$9 = /* @__PURE__ */ __name$l(function(e) {
      e.preventDefault();
    ...
    var submit$6 = /* @__PURE__ */ __name$i(function(e) {
      e.preventDefault();
      this.close();
    }, "submit");
    ...
    var submit$5 = /* @__PURE__ */ __name$8(function(e) {
      e.preventDefault();
      this.close();
    }, "submit");
